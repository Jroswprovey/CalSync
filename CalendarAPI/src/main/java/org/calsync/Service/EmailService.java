...
public class EmailService {
    ...
    private static final String USERNAME = "jroswprovey@gmail.com";
    private static final String PASSWORD = "xbgp azkn lbwt wzvl";
    ...
    public static void main(String[] args) {
        ...
        sendEmail("recipient@example.com", "Test Email", "Justin");
    }
}
